...
void test_init_data_truncate(void)
{
    ...
    string_t s = {0};
    core_string_init_data(&s, 4, "hello");
    assert(s._String_Data != NULL);
...
{
    string_t src = {0};
    core_string_init_data(&src, 16, "copy me");
    string_t dst = {0};
    core_string_init(&dst, 16);
...
{
    string_t src = {0};
    core_string_init_data(&src, 32, "a longer source string");
    string_t dst = {0};
    core_string_init(&dst, 4);
    int r = core_string_copy(&dst, &src);
    assert(r == SUCCESS);
...
{
    string_t a = {0};
    core_string_init_data(&a, 16, "same");
    string_t b = {0};
    core_string_init_data(&b, 16, "same");
...
{
    string_t a = {0};
    core_string_init_data(&a, 16, "hello");
    string_t b = {0};
    core_string_init_data(&b, 16, "world");
...
{
    string_t s = {0};
    core_string_init_data(&s, 16, "hello");
...
{
    string_t a = {0};
    core_string_init_data(&a, 16, "foo");
    string_t b = {0};
    core_string_init_data(&b, 16, "bar");
...
{
    string_t s = {0};
    core_string_init_data(&s, 16, "abc");
...
{
    string_t s = {0};
    core_string_init_data(&s, 16, "aabbaa");
...
{
    string_t s = {0};
    core_string_init_data(&s, 16, "bye");
    core_string_destroy(&s);
    assert(s._String_Data == NULL);
...
void test_null_guards(void)
{
    ...
    assert(core_string_set(NULL, "x") == STRING_POINTER_NULL_ERROR);
    assert(core_string_copy(NULL, NULL) == STRING_POINTER_NULL_ERROR);
    assert(core_string_compare(NULL, NULL) == STRING_POINTER_NULL_ERROR);
    assert(core_string_pop_back(NULL) == STRING_POINTER_NULL_ERROR);
    assert(core_string_append_char(NULL, 'x') == STRING_POINTER_NULL_ERROR);
    assert(core_string_append_cstr(NULL, "x") == STRING_POINTER_NULL_ERROR);
    assert(core_string_append_string(NULL, NULL) == STRING_POINTER_NULL_ERROR);
}
